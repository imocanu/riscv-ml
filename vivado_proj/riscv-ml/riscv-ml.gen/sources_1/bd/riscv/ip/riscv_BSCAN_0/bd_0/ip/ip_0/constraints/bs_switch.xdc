...
create_clock -period 33 [get_pins -filter {REF_PIN_NAME=~TCK} -of_objects [get_cells -hierarchical -filter {NAME =~ "*BSCAN_SWITCH.N_EXT_BSCAN.bscan_inst/SERIES7_BSCAN.bscan_inst*"}]]
